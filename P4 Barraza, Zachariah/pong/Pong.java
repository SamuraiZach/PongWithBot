...
public class Pong implements ActionListener, KeyListener
{
	...
	public void render(Graphics2D g)
	{
		...
		if (gameStatus == 0)
		{
			...
			g.drawString("PONGO", width / 2 - 75, 50);
			...
			if (!selectingDifficulty)
			{
				...
				g.drawString("Score Limit: " + scoreLimit, width / 2 - 120, height / 2 + 75);
				g.drawString("By: Ya Boi Zacharoo (Zachariah Barraza)", width / 2 - 280, height / 2 + 120);
			}
		}
